...
_EXPORTS = {
    ...
    "LineBreak": "docscriptor.components.inline",
    "Math": "docscriptor.components.inline",
    "Monospace": "docscriptor.components.inline",
    "MultiColumn": "docscriptor.components.blocks",
