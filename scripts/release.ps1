...
Write-Host "GitHub Actions will run tests, build release artifacts, render the guide PDFs, publish the GitHub Release, and upload Python distributions to PyPI."
